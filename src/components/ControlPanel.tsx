        ...
        <div className="flex items-center gap-3 mt-4 md:mt-0">
            ...
            <input 
                ...
                onChange={(e) => {
                  ...
                  if (isNaN(val)) setTargetLevel(0);
                  else if (val > 100) setTargetLevel(100);
                  else setTargetLevel(val);
                }}
                className="bg-slate-800 border border-slate-700 text-white px-3 py-1.5 rounded-lg w-24 focus:outline-none focus:ring-2 focus:ring-primary-500 text-center no-spinner"
                placeholder="0 (None)"
            />
